...
class RangeUtilsTest {
  ...
  void splitOverDays_timeEntryWithinTwoCalendarDays_returnTwoDateTimeRanges() {
    ...
    TreeMap<LocalDate, Range<ZonedDateTime>> ranges = splitOverDays(startTime, endTimeNextDay);
  ...
  void splitOverDays_timeEntryWithinFourCalendarDays_returnFourDateTimeRanges() {
    ...
    TreeMap<LocalDate, Range<ZonedDateTime>> ranges = splitOverDays(startTime, endTime);
